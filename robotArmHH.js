     ...
     window.addEventListener("keydown", function(e){
         switch( e.keyCode ) {
            ...
            case 87:	// w - snýr efri armi
                ...
                break;
            case 69:	// e - snýr enda armi
			    theta[3] = Math.min(170, theta[3]+5);
                break;
            case 82:	// r - snýr enda armi
...
//----------------------------------------------------------------------------
function finalArmFun() 
{
    var s = scalem(FINAL_ARM_WIDTH, FINAL_ARM_HEIGHT, FINAL_ARM_WIDTH);
    var instanceMatrix = mult( translate( 0.0, 0.5 * FINAL_ARM_HEIGHT, 0.0 ), s);
    var t = mult(modelViewMatrix, instanceMatrix);
    gl.uniformMatrix4fv( modelViewMatrixLoc,  false, flatten(t) );
    gl.drawArrays( gl.TRIANGLES, 0, NumVertices );
}
...
var render = function() {
    ...
    modelViewMatrix  = mult(modelViewMatrix, translate(0.0, FINAL_ARM_HEIGHT, 0.0));
    modelViewMatrix  = mult(modelViewMatrix, rotateZ( theta[finalArm] ) );
    finalArmFun();
